...
export const BottomNav: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-theme-main/95 backdrop-blur-lg border-t border-theme pt-2 px-6 pb-4 z-50 transition-colors duration-300" style={{ paddingBottom: 'calc(1rem + env(safe-area-inset-bottom))' }}>
